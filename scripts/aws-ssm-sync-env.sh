...
Examples:
  $0 --file docker/.env.app.prod --prefix /gpool/prod/app --region us-east-1 --secure-keys OPENBAO_TOKEN
  $0 --file docker/.env.app.prod --prefix /gpool/prod/app --region us-east-1 --dry-run
USAGE
}
